...
df_test = get_dataset('amazon_reviews_multi', dataset_type="test")
...
PATH= f'./amazon-{model_name}/finetuned_{pth_type}_{pth_index}.pth'
...
with torch.no_grad():
    for batch in train_dataloader:
        ...
        ans=torch.cat((ans_1, ans_2, ans_3, ans_4, ans_5), dim=0).reshape(5, -1).T
        accurate += ((ans.argmax(1)+1) == b_labels).sum() 
        total+=batch_size
