...
parser.add_argument('--type', type=str, required=True,
                   choices=['pseudo', 'confidence', 'dropout', 'unconf', 'base'])
...
df_test = get_dataset('ag_news', dataset_type='test')
...
PATH= f'./ag_news-{model_name}/finetuned_{pth_type}_{pth_index}.pth'
if pth_type == 'base':
    PATH = {
...
with torch.no_grad():
    for batch in train_dataloader:
        ...
        ans=torch.cat((ans_1, ans_2, ans_3, ans_4), dim=0).reshape(4, -1).T
